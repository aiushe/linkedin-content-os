...
| Retrieval | **Pre-registered before `improved-3`:** rank story candidates by verified-metric overlap before general lexical relevance. | C2 | Story top-1 +15pp, with a risk to topical-but-nonmetric cases. | TBD |
